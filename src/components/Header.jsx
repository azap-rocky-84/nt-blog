            ...
            {userState.userInfo ? (
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <div className={`${profileDropdown ? "block" : 'hidden'} lg:hidden transition-all duration-500 pt-4 lg:absolute lg:bottom-0 lg:right-0 lg:transform lg:translate-y-full lg:group-hover:block w-max`}>
                    ...
                    <button className='mt-5 lg:mt-0 border-2 border-[#2E8B57] px-6 py-2 rounded-full text-[#2E8B57] font-semibold hover:bg-[#2E8B57] hover:text-white transition-all duration-300'>Login</button>
                )}
