...
const ProfilePictures = ({avatar}) => {
  return <div className='w-full flex items-center gap-x-4'>
    <div className='relative w-20 h-20 rounded-full outline outline-offset-2 outline-1 lutline-primary overflow-hidden'>
        ...
        <input type="file" className='sr-only' id='profilePictures' />
    </div>
    <button type='button' className='border border-red-500 rounded-lg px-4 py-2 text-red-500'>Cancella</button>
  </div>
}
