...
const EditPost = () => {
    ...
    const {data, isLoading, isError} = useQuery({
      ...
      const handleDeleteImage = () => {
        if(window.confirm("Vuoi davvero eliminare l'immagine del post?")){
      ...
      {isLoading ? (
        ...
        <section className='container mx-auto max-w-5xl flex flex-col px-5 py-5 lg:flex-row lg:gap-x-5 lg:items-start'>
           <article className='flex-1'>
            ...
            <button type="button" onClick={handleDeleteImage} className='w-fit bg-red-500 text-sm text-white font-semibold rounded-lg px-2 py-1 mt-5'>Elimina immagine</button>
